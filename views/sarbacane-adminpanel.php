...
<div id="sarbacane_desktop_content">
	...
	<div id="sarbacane_desktop_configuration">
		<div class="sarbacane_desktop_configuration_panel">
			...
			<form method="POST" autocomplete="off">
				...
				<p>
					<?php if ( $key != '' ) { ?>
					<input type="submit" class="sarbacane_desktop_configuration_button" value="<?php esc_attr_e( 'Generate another key', 'sarbacane-desktop' ) ?>" />
					<?php } else { ?>
					<input type="submit" class="sarbacane_desktop_configuration_button" value="<?php esc_attr_e( 'Generate a key', 'sarbacane-desktop' ) ?>" />
					<?php }?>
				</p>
			</form>
		</div>
		<div id="sarbacane_desktop_configuration_footer">
			<p class="sarbacane_desktop_configuration_footer_help sarbacane_desktop_configuration_button_container">
				<?php if ( $sd_list_news ) { ?>
					<input type="button" onclick="sarbacaneGoWidget()" class="sarbacane_desktop_configuration_button sarbacane_desktop_configuration_button_green" value="<?php esc_attr_e( 'Setup the widget', 'sarbacane-desktop' ) ?>"/>
				<?php }?>
			</p>
		</div>
	</div>
	...
	<div id="sarbacane_desktop_help">
		...
		<p class="sarbacane_desktop_help_subtitle">
			<?php _e( 'For more details', 'sarbacane-desktop' ) ?> : <a href="<?php _e( 'https://www.sarbacane.com/ws/soft-redirect.asp?key=9Y4OtEZzaz&com=WordpressInfo', 'sarbacane-desktop' ) ?>"><?php _e( 'Take a look at the help section online', 'sarbacane-desktop' ) ?></a>
		</p>
		<p class="sarbacane_desktop_div_splitter"></p>
		<div class="sarbacane_desktop_help_title">
