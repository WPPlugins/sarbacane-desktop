		...
		<form method="POST" action="" autocomplete="off">
			<div class="sarbacane_desktop_configuration_panel">
				...
				<p class="sarbacane_desktop_config_label">
					...
					<label for="sarbacane_users_list"><?php _e( 'Synchronize a \'\'WordPress Users\'\' list', 'sarbacane-desktop' ) ?></label>
					<br />
				...
				<p class="sarbacane_desktop_config_label">
					...
					<label for="sarbacane_news_list"><?php _e( 'Automatically synchronize your subscriber list', 'sarbacane-desktop' ) ?></label>
					<br />
			...
			<div class="sarbacane_desktop_configuration_panel">
				...
				<p class="sarbacane_desktop_config_label">
					...
					<label for="sarbacane_theme_sync"><?php _e( 'Synchronize your WordPress theme', 'sarbacane-desktop' ) ?></label>
					<br />
				...
				<p class="sarbacane_desktop_config_label">
					...
					<label for="sarbacane_blog_content"><?php _e( 'Synchronize blog content', 'sarbacane-desktop' ) ?></label>
					<br />
				...
				<p class="sarbacane_desktop_config_label" style="display:none;">
					...
					<label for="sarbacane_media_content"><?php _e( 'Synchronize media library', 'sarbacane-desktop' ) ?></label>
					<br />
				...
				<p class="sarbacane_desktop_config_label">
					...
					<label for="sarbacane_rss_data"><?php _e( 'Synchronize RSS data', 'sarbacane-desktop' ) ?></label>
					<br />
			...
			<div id="sarbacane_desktop_configuration_footer">
				<p class="sarbacane_desktop_configuration_footer_help sarbacane_desktop_configuration_button_container">
					<input type="submit" class="sarbacane_desktop_configuration_button sarbacane_desktop_configuration_button_green" value="<?php esc_attr_e( 'Save', 'sarbacane-desktop' ) ?>"/>
				</p>
			</div>
...
<div class="sarbacane_desktop_popup">
	...
	<div class="sarbacane_desktop_popup_content">
		<p><?php _e( 'Careful, if you deactivate this list, the \'Contact form\' widget and the associated list in Sarbacane Desktop will be deactivated too. Are you sure you wish to deactivate the list?', 'sarbacane-desktop' ) ?></p>
		<p>
			<input type="button" onclick="sarbacaneNewsListChangePopupOk()" class="sarbacane_desktop_configuration_button sarbacane_desktop_configuration_button_green" value="<?php esc_attr_e( 'Yes', 'sarbacane-desktop' ) ?>"/>
			<input type="button" onclick="sarbacaneNewsListChangePopupNo()" class="sarbacane_desktop_configuration_button" value="<?php esc_attr_e( 'No', 'sarbacane-desktop' ) ?>"/>
		</p>
	</div>
</div>
<?php } ?>
