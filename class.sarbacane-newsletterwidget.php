...
class SarbacaneNewsWidget extends WP_Widget {
	...
	public function display_registration_message($valid) {
		if ( $valid ) {
			$message = json_encode( array( 'message' => get_option( 'sarbacane_news_registration_message', __( 'Congrats! You signed up for our newsletter.', 'sarbacane-desktop' ) ) ) );
		} else {
	...
	public function widget( $args, $instance ) {
		...
		$registration_mandatory_fields = get_option( 'sarbacane_news_registration_mandatory_fields', __( 'Fields marked with * are mandatory', 'sarbacane-desktop' ) );
		$list_type = 'N';
	...
	public function display_settings() {
		...
		$title = get_option( 'sarbacane_news_title', __( 'Newsletter', 'sarbacane-desktop' ) );
		$description = get_option( 'sarbacane_news_description', '' );
		$registration_message = get_option( 'sarbacane_news_registration_message', __( 'Congrats! You signed up for our newsletter.', 'sarbacane-desktop' ) );
		$registration_button = get_option( 'sarbacane_news_registration_button', __( 'Inscription', 'sarbacane-desktop' ) );
		$registration_mandatory_fields = get_option( 'sarbacane_news_registration_mandatory_fields', __( 'Fields marked with * are mandatory', 'sarbacane-desktop' ) );
