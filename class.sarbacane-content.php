...
xmlns:slash="http://purl.org/rss/1.0/modules/slash/">
	...
	public function get_article_rss( $post_id ) {
		...
		if ( $query->have_posts() ) {
			echo $this->get_rss_header() . $this->get_rss_content( 'post', $post_id ) . $this->get_rss_footer();
		} else {
	...
	public function get_articles_rss( $limit ) {
		echo $this->get_rss_header() . $this->get_rss_content( 'posts', $limit ) . $this->get_rss_footer();
	}
