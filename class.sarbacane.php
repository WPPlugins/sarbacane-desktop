...
class Sarbacane {
	...
	public static function activation() {
		...
		update_option( 'sarbacane_news_registration_button', __( 'Inscription', 'sarbacane-desktop' ), false );
	...
	private function sarbacane_params_saved() {
		echo '<div class="updated">' . __( 'A new key has been generated', 'sarbacane-desktop' ) . '</div>';
	}
